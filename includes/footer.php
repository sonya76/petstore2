<div class="haut">
    <div class="icone">
        <div><i class="fa-solid fa-box-open fa-4x"></i><span><strong> Livraison en 2 à 5 jours ouvrés</strong></span></div>
    </div>
    <div class="icone">
        <div><i class="fa-solid fa-store fa-4x"></i><span><strong> Click & collect sous 2h en magasin</strong></span></div>
    </div>
    <div class="icone">
        <div><i class="fa-solid fa-truck-fast fa-4x"></i><span><strong> Livraison offerte dès 49€</strong></span></div>
    </div>
    <div class="icone">
        <div><i class="fa-solid fa-shield fa-4x"></i><span><strong> Paiement sécurisé</strong></span></div>
    </div>
</div>
<footer class="footer">
    ...
    <div class="footer__addr">
        ...
        <div class="footer__iconesSocial">
            ...
            <a href="#"><i class="fa-brands fa-facebook-square fa-xl a"></i></a>
            <a href="#"><i class="fa-brands fa fa-linkedin-square fa-xl a"></i></a>
            <a href="#"><i class="fa-brands fa-instagram fa-xl a"></i></a>
            <a href="#"><i class="fa-brands fa-youtube fa-xl a"></i></a>
        </div>
    </div>
